from PySide6.QtWidgets import (
    ...
    QTabWidget, QTextEdit, QComboBox, QLineEdit, QTimeEdit,
    QCheckBox, QScrollArea, QFrame, QGroupBox, QFormLayout,
    QSpinBox
)
...
class BriefingWidget(QWidget):
    ...
    def create_style_tab(self):
        ...
        style_edit.setPlaceholderText("Descreva o estilo visual desejado para as produções...")
    ...
    def create_references_tab(self):
        ...
        references_edit.setPlaceholderText("Links e referências para o estilo visual...")
    ...
    def create_sponsors_tab(self):
        ...
        # Instruções
        instructions = QLabel("Adicione patrocinadores e suas ações/ativações durante o evento:")
    ...
    def create_sponsor_widget(self, name):
        ...
        sponsor_selector.addItems(["+ Novo patrocinador", "Patrocinador C", "Patrocinador D"])
    ...
    def create_action_widget(self):
        ...
        responsible.addItems(["Selecionar responsável", "João Silva", "Maria Souza", "Carlos Lima"])
    ...
    def create_schedule_tab(self):
        ...
        # Instruções
        instructions = QLabel("Adicione a programação completa do evento, organizada por palco:")
        instructions.setStyleSheet(f"color: {style.foreground_color}; font-size: 14px;")
        instructions.setWordWrap(True)
    ...
    def create_rt_delivery_widget(self):
        ...
        platforms_group.setStyleSheet(f"""
            QGroupBox {{
