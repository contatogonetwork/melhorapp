from PySide6.QtWidgets import (
    ...
    QDateEdit, QLineEdit, QComboBox, QMessageBox
)
...
class EventWidget(QWidget):
    def __init__(self):
        ...
        self.type_filter.addItems(["Todos os Tipos", "Corporativo", "Festival", "Conferência", "Lançamento", "Outro"])
        ...
        self.status_filter.addItems(["Todos os Status", "Em planejamento", "Confirmado", "Em andamento", "Concluído", "Cancelado"])
        ...
        self.events_table.setHorizontalHeaderLabels(["Nome do Evento", "Data", "Local", "Cliente", "Status", "Ações"])
        ...
        self.events_table.horizontalHeader().setSectionResizeMode(5, QHeaderView.ResizeMode.ResizeToContents)
        ...
        self.add_event_frame.setStyleSheet(f"""
            QFrame {{
        ...
        self.add_event_title.setStyleSheet(f"color: {style.purple_color}; font-size: 18px; font-weight: bold;")
        ...
        self.event_client_input.addItems(["Selecione um cliente", "Empresa ABC", "XYZ Corp", "Tech Solutions", "Novo Cliente..."])
        ...
        self.event_type_input.addItems(["Corporativo", "Festival", "Conferência", "Lançamento", "Outro"])
        ...
        self.event_status_input.addItems(["Em planejamento", "Confirmado", "Em andamento", "Concluído", "Cancelado"])
    ...
    def add_sample_events(self):
        # Dados de exemplo
        events = [
            ["Festival de Música", "18-20 Mai 2025", "Arena São Paulo", "Empresa ABC", "Em planejamento"],
            ["Lançamento de Produto", "25 Mai 2025", "Centro de Convenções", "XYZ Corp", "Confirmado"],
            ["Conferência Tech", "01 Jun 2025", "Hotel Grand", "Tech Solutions", "Em planejamento"],
            ["Treinamento Corporativo", "15 Jun 2025", "Sede da Empresa", "Consultoria DEF", "Confirmado"],
            ["Premiação Anual", "30 Jun 2025", "Teatro Municipal", "Associação GHI", "Em planejamento"],
        ]
