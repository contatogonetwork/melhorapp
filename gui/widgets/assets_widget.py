from PySide6.QtWidgets import (
    ...
    QFrame, QComboBox, QLineEdit, QGridLayout, QScrollArea,
    QFileDialog, QMenu
)
...
class AssetCard(QFrame):
    def __init__(self, name, asset_type, file_path=""):
        ...
        self.name_label.setStyleSheet(f"color: {style.foreground_color}; font-size: 12px;")
...
class AssetsWidget(QWidget):
    def __init__(self):
        ...
        self.type_filter.addItems(["Todos os Tipos", "Imagem", "Vídeo", "Áudio", "Logo", "Outro"])
        
        # Filtro por categoria
        self.category_filter = QComboBox()
        self.category_filter.setStyleSheet(style.combobox_style)
        self.category_filter.setFixedHeight(36)
        self.category_filter.addItems(["Todas as Categorias", "Patrocinadores", "Artistas", "Mídia", "Templates"])
