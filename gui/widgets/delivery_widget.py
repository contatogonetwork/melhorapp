...
from PySide6.QtGui import QBrush, QColor, QFont, QIcon  # Adicionado QFont aqui
...
class DeliveryWidget(QWidget):
    def __init__(self):
        ...
        self.completed_frame.setStyleSheet(
            f"""
            QFrame {{
                background-color: {style.background_color};
                border-radius: 8px;
        ...
        self.completed_title.setStyleSheet(
            f"color: {style.comment_color}; font-size: 14px;"
        )

        self.completed_value = QLabel("16")
        self.completed_value.setStyleSheet(
            f"color: {style.green_color}; font-size: 30px; font-weight: bold;"
        )
        ...
        self.progress_value.setStyleSheet(
            f"color: {style.orange_color}; font-size: 30px; font-weight: bold;"
        )
        ...
        self.late_value.setStyleSheet(
            f"color: {style.red_color}; font-size: 30px; font-weight: bold;"
        )
        ...
        self.responsible_filter.addItems(
            ["Todos os Responsáveis", "Maria Souza", "Pedro Alves"]
        )
        ...
        self.deliveries_table.setHorizontalHeaderLabels(
            ["Entrega", "Prazo", "Responsável", "Status", "Progresso", "Ações"]
        )
        self.deliveries_table.horizontalHeader().setSectionResizeMode(
        ...
        self.overall_percentage.setStyleSheet(
            f"color: {style.purple_color}; font-size: 14px; font-weight: bold;"
        )
    ...
    def add_sample_deliveries(self):
        ...
        deliveries = [
            ...
            [
                "Entrevista com artista principal",
                "Hoje, 19:45",
                "Pedro Alves",
                "Entregue para revisão",
                90,
