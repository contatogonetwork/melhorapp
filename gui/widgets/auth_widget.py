from PySide6.QtWidgets import (
    ...
    QHBoxLayout, QCheckBox, QFrame, QTabWidget, QFormLayout
)
...
class AuthWidget(QWidget):
    ...
    def __init__(self):
        ...
        self.auth_panel.setStyleSheet(f"""
            QFrame {{
        ...
        self.register_label.setStyleSheet(f"color: {style.foreground_color}; text-align: center;")
