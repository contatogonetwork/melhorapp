...
class LoginWidget(QWidget):
    ...
    def __init__(self):
        ...
        self.logo_label.setStyleSheet(
            f"color: {style.purple_color}; font-size: 16px; font-weight: bold;"
        )
        ...
        self.version_label.setStyleSheet(
            f"color: {style.comment_color}; font-size: 12px;"
        )
    ...
    def show_message(self, title, message):
        ...
        msg_box.setIcon(
            QMessageBox.Warning if "Erro" in title else QMessageBox.Information
        )
