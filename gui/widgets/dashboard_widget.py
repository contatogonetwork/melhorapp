from PySide6.QtWidgets import (
    ...
    QFrame, QTableWidget, QTableWidgetItem, QHeaderView, QProgressBar, QMessageBox
)
...
class DashboardWidget(QWidget):
    def __init__(self):
        ...
        self.events_section.setStyleSheet(f"""
            QFrame {{
        ...
        self.events_title.setStyleSheet(f"color: {style.foreground_color}; font-size: 16px; font-weight: bold;")
        ...
        self.events_table.setHorizontalHeaderLabels(["Nome do Evento", "Data", "Status", "Ações"])
        ...
        self.tasks_section.setStyleSheet(f"""
            QFrame {{
                background-color: {style.background_color};
                border-radius: 8px;
                border: 1px solid {style.current_line_color};
        ...
        self.tasks_title.setStyleSheet(f"color: {style.foreground_color}; font-size: 16px; font-weight: bold;")
        ...
        self.tasks_table.setHorizontalHeaderLabels(["Descrição", "Projeto", "Progresso", "Ações"])
    ...
    def create_stat_card(self, title, value, color, icon_name):
        ...
        icon = QLabel()
        icon.setPixmap(QIcon(f"./resources/icons/{icon_name}.svg").pixmap(QSize(20, 20)))
    ...
    def add_sample_events(self):
        ...
        for row, event in enumerate(events):
            ...
            view_btn.clicked.connect(lambda checked=False, t=event[0]: self.ver_detalhes(t))
    ...
    def ver_todos_eventos(self):
        ...
        QMessageBox.information(self, "Eventos", "Exibindo lista completa de todos os eventos")

    def ver_detalhes(self, titulo="Item"):
        """Exibe detalhes de um item específico"""
        QMessageBox.information(self, f"Detalhes - {titulo}", f"Exibindo detalhes de: {titulo}")

    def ver_todas_tarefas(self):
        """Exibe todas as tarefas"""
        QMessageBox.information(self, "Tarefas", "Exibindo lista completa de todas as tarefas")