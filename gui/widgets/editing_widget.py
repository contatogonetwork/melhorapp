from PySide6.QtWidgets import (
    ...
    QFrame, QScrollArea, QLineEdit, QComboBox, QSplitter,
...
class VideoPlayer(QFrame):
    def __init__(self):
        ...
        self.fullscreen_button.setIcon(QIcon("./resources/icons/fullscreen.svg"))
...
class CommentItem(QFrame):
    def __init__(self, user, timestamp, text):
        ...
        self.reply_button.setStyleSheet(f"""
            QPushButton {{
...
class EditingWidget(QWidget):
    def __init__(self):
        ...
        self.videos_widget.setStyleSheet(f"""
            QFrame {{
        ...
        self.videos_title.setStyleSheet(f"color: {style.foreground_color}; font-size: 16px; font-weight: bold;")
        ...
        self.videos_list.setStyleSheet(f"""
            QListWidget {{
                background-color: {style.background_color};
                border-radius: 5px;
        ...
        self.editor_widget.setStyleSheet(f"""
            QFrame {{
                background-color: {style.background_color};
                border-radius: 8px;
            }}
        ...
        self.video_title.setStyleSheet(f"color: {style.foreground_color}; font-size: 18px; font-weight: bold;")
        ...
        self.editor_label.setStyleSheet(f"""
            color: {style.foreground_color};
        """)
        ...
        self.comments_title.setStyleSheet(f"color: {style.foreground_color}; font-size: 16px; font-weight: bold;")
        ...
        self.comments_layout.addWidget(CommentItem("Ana Costa", "Hoje, 15:30", "O áudio está um pouco baixo na introdução. Pode aumentar o volume nos primeiros 15 segundos?"))
        self.comments_layout.addWidget(CommentItem("Carlos Lima", "Hoje, 16:05", "Gostei muito da transição aos 0:45, ficou muito suave!"))
        self.comments_layout.addWidget(CommentItem("Cliente XYZ", "Hoje, 16:20", "A logomarca do patrocinador precisa ficar mais tempo em tela, pelo menos 3 segundos."))
        ...
        self.main_splitter.setStretchFactor(1, 2)  # Dar mais espaço para o editor
