...
create_icon(
    "minimize",
    """<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke="#fff" stroke-width="2">
...
# Outros ícones essenciais para as ações
create_icon(
    "view",
    """<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke="#fff" stroke-width="2">
...
print("Ícones essenciais criados com sucesso!")
