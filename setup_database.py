...
def insert_sample_data():
    ...
    try:
        ...
        editor_password = bcrypt.hashpw("editor123".encode('utf-8'), bcrypt.gensalt()).decode('utf-8')
        client_password = bcrypt.hashpw("client123".encode('utf-8'), bcrypt.gensalt()).decode('utf-8')
        ...
        briefing_id = db.insert("briefings", {
            'event_id': event_id,
        ...
        sponsor_id = db.insert("sponsors", {
            'event_id': event_id,
            'name': 'Bebidas RefreshCo'
        })
        
        # Adicionar ações do patrocinador
        db.insert("sponsor_actions", {
