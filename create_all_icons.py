...
icons = [
    ...
    "menu", "minimize", "maximize", "close", "dashboard", "calendar", "team",
    "document", "timeline", "video", "delivery", "folder", "settings",
    "logout", "restore", "arrow-down", 
    
    # Ícones de status e indicadores
    "calendar-active", "delivery-today", "pending-edit", "approval",
    
    # Ícones de ações
    "plus", "edit", "view", "add-event", "user", "timeline-generate", 
    "save", "trash", "refresh", "export", "check", "download", "play",
    "fullscreen", "comment", "upload", "info", "more",
    
    # Tipos de arquivos e assets
    "image", "video", "audio", "logo", "file"
]
